...
import {
  http
} from "./chunk-SYFKYGOG.js";
import "./chunk-6UNWIC66.js";
import {
  ripemd160,
  withRetry,
  withTimeout
} from "./chunk-33JFT3X3.js";
import {
  Field,
  FpInvertBatch,
  FpLegendre,
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-IPVMHCLZ.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-BZYRUSOL.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-YSC5JAPU.js");
